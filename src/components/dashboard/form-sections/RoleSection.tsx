...
import { STATUS_OPTIONS as _, WORK_TYPE_OPTIONS, EMPLOYMENT_TYPE_OPTIONS } from '../../../constants/status';
  ...
  <section className="form-section">
    ...
    <div className="form-grid-2">
      <div className="form-field">
        ...
        <input className={`form-input ${errors.position ? 'input-error' : ''}`} placeholder="e.g. Senior Engineer" value={form.position} onChange={onChange('position')} />
      ...
      <div className="form-field">
        ...
        <select className="form-select" value={form.employmentType} onChange={onChange('employmentType')}>
