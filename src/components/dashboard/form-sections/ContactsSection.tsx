    ...
    <div className="form-grid-2">
      ...
      <div className="form-field">
        ...
        <input
          ...
          onChange={onChange('recruiterName')}
        />
      </div>
      <div className="form-field">
        ...
        <input
          ...
          onChange={onChange('recruiterEmail')}
        />
      </div>
      <div className="form-field">
        ...
        <input
          ...
          onChange={onChange('recruiterPhone')}
        />
      </div>
      ...
      <div className="form-field">
        ...
        <input
          ...
          onChange={onChange('referralDate')}
        />
      </div>
      <div className="form-field" style={{ gridColumn: '1 / -1' }}>
        <label>Note</label>
        <input
          ...
          onChange={onChange('referralNote')}
        />
      </div>
      <div className="form-field">
        ...
        <input
          type="url"
          className="form-input"
          placeholder="https://careers.company.com/ref/…"
          value={form.referralLink}
          onChange={onChange('referralLink')}
        />
      </div>
      <div className="form-field">
