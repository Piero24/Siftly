...
export const ApplicationSection: React.FC<ApplicationSectionProps> = ({ form, onChange, setForm }) => (
    ...
    <div className="form-field">
      ...
      <div className="form-grid-2" style={{ marginTop: '8px' }}>
        {form.salaryType === 'single' ? (
          <div className="form-field">
            <input type="number" className="form-input" placeholder="e.g. 120000" value={form.salaryAmount} onChange={onChange('salaryAmount')} min="0" />
          </div>
        ) : (
          <>
            <div className="form-field">
              <input type="number" className="form-input" placeholder="Min (e.g. 90000)" value={form.salaryMin} onChange={onChange('salaryMin')} min="0" />
            </div>
            <div className="form-field">
              <input type="number" className="form-input" placeholder="Max (e.g. 140000)" value={form.salaryMax} onChange={onChange('salaryMax')} min="0" />
            </div>
          </>
        )}
        <div className="form-field">
          <select className="form-select" value={form.salaryCurrency} onChange={onChange('salaryCurrency')}>
