...
export const LinksSection: React.FC<LinksSectionProps> = ({ form, onChange }) => (
  <section className="form-section">
    ...
    <div className="form-field">
      ...
      <input type="url" className="form-input" placeholder="https://careers.company.com/job-id" value={form.jobUrl} onChange={onChange('jobUrl')} />
    </div>
    <div className="form-grid-2">
      ...
      <div className="form-field">
        ...
        <input type="url" className="form-input" placeholder="https://company.com" value={form.websiteUrl} onChange={onChange('websiteUrl')} />
      </div>
    </div>
  </section>
);
