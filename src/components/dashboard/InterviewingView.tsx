        ...
        >
          ...
          {r.interviewerContact &&
            (r.interviewerContact.includes('@') ? (
              <a
                href={`mailto:${r.interviewerContact}`}
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '6px',
