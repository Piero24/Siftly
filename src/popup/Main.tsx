            ...
            <div className="popup-brand">
              ...
              <div className="popup-heading-wrap">
                <div className="popup-title-row">
                  ...
                  {isOffline ? (
                    <span className="popup-status-tag" style={{ color: '#d93025', background: 'rgba(217, 48, 37, 0.1)', flexShrink: 0 }}>
                      OFFLINE
                    </span>
                  ) : !isAuthenticated ? (
                    <span className="popup-status-tag" style={{ color: '#E58A00', background: 'rgba(229, 138, 0, 0.1)', flexShrink: 0 }}>
                      LOGGED OUT
                    </span>
                  ) : IS_DEBUG ? (
